  ...
  export default {
    ...
    mounted() {
      ...
      this.checkWeiXinBrowser(function () {
        console.log("this is wechat1111");
    ...
    methods: {
      confirmLesson(){
        ...
        _this.request({
          ...
          param: {"lessonId":this.params.lessonId,"type":"MESSAGE_LESSON_INFLATED"},
        ...
        _this.request({
          ...
          success: function (result) {
            ...
            if (result.code == 200) {
              ...
              _this.beforeClassData = result.result.previewInfoList;
            }
          },
          error: function (error) {
            //服务器异常
            _this.$message.error('获取课前预习失败,网络加载失败，去右上角菜单中刷新页面。')
          }
        })
      },
      //微信预览图片
