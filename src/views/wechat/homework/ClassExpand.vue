  ...
  <div class="wechat-content-homework">
    ...
    <div class="homework-content">
      <div class="before-class-title" >
        ...
        <p>第{{homeworkIndex}}课 课后拓展</p>
      </div>
      <div v-for="(item,idx) in beforeClassData" v-if="beforeClassData.length>0">
    ...
    methods: {
      confirmLesson(){
        ...
        _this.request({
          ...
          param: {"lessonId":this.params.lessonId,"type":"MESSAGE_LESSON_EXPANSION"},
        ...
        _this.request({
          ...
          success: function (result) {
            ...
            if (result.code == 200) {
              ...
              _this.beforeClassData = result.result.expandInfoList;
            }
          },
          error: function (error) {
            //服务器异常
            _this.$message.error('获取课后拓展失败,网络加载失败，去右上角菜单中刷新页面。')
          }
        })
      },
      //微信预览图片
