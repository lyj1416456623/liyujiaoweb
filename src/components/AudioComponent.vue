<template>
  <!--<div>自定义audio播放器样式---课前预习、课后拓展、作业题目、作业解析中的音频</div>-->
  <div class="audio-block">
    ...
    <div class="line"></div>
    <el-slider v-model="sliderTime" :format-tooltip="formatProcessToolTip" @change="changeCurrentTime" class="slider slider-audio" style="width: 100%;"></el-slider>
  </div>
</template>
